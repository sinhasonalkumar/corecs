package corecs.graph.dfs.undirected.ajdmatrix;
...
public class UndirectedGraphAdjMatrixDFS {
	...
	7	[0, 0, 0, 0, 0, 0, 0, 0]
 	...
 	// Definition of nighbours is value 1 in col for given row
 	 
 	example 
 		Vertices : 0,1,2,3,4,5,6,7
 		neighbours of Vertex : 0 --> 1, 6
 ...
 */
	...
	public static void dfsHelper(int curVertex, UnDirectedGraph graph, List<Integer> visitedVertexList) {
		
		System.out.println(curVertex);
		visitedVertexList.add(curVertex);
		
		for (Integer curNeighbourVertex : getNeighBourVertexList(curVertex, graph)) {
